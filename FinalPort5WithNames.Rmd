...
sum(df1$SAMPLE_SIZE_HC + df1$SAMPLE_SIZE_SZ, na.rm = T)

sum(df1$SAMPLE_SIZE_HC, na.rm = T)

sum(df1$SAMPLE_SIZE_SZ, na.rm = T)
...
sum(df_pitch$SAMPLE_SIZE_HC, na.rm = T)

sum(df_pitch$SAMPLE_SIZE_SZ, na.rm = T)
```
